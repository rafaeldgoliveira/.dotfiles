...
echo -e "${GREEN}O idioma foi definido para: $(cat /etc/default/locale)${WHITE}"
...
Deleta configs
echo -e "${GREEN}Deletando as configurações padrão do SO${WHITE}"
rm -rf $HOME/.aliases
